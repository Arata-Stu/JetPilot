...
def generate_launch_description() -> lut.LaunchDescription:
    ...
    args.add_arg('sensor_kit_enable_gyro', True, cli=True)
    ...
    args.add_arg('sensor_kit_silky_evcam_event_image_style', 'gep', cli=True)
    ...
    args.add_arg('e2e_event_stride_ms', '4.0', cli=True)
