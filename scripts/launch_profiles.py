...
SENSOR_KIT_INTEGRATION_ARGUMENTS = {
    ...
    "e2e_event_tensor_debug",
    "e2e_event_tensor_diagnostics_topic",
    "e2e_event_tensor_mean",
    "e2e_event_tensor_memory_pool_num_blocks",
    "e2e_event_tensor_mode",
    "e2e_event_tensor_publisher_depth",
    "e2e_event_tensor_statistics_interval_s",
    "e2e_event_tensor_stddev",
    "e2e_event_tensor_subscription_depth",
    "e2e_event_tensor_use_pinned_host_memory",
    "e2e_event_bins",
    "e2e_event_cuda_events_per_transfer",
    "e2e_event_cuda_update_us",
    "e2e_event_inference_policy",
    "e2e_event_inference_watchdog_ms",
    "e2e_event_incremental_mode",
    "e2e_event_polarity_layout",
    "e2e_event_polarity_mode",
    "e2e_event_representation_backend",
    "e2e_event_stride_ms",
    "e2e_event_temporal_interpolation",
    "e2e_event_topic",
    "e2e_event_window_ms",
    "e2e_image_topic",
    "e2e_model_root",
