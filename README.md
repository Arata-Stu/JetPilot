...
```bash
./scripts/repos.sh                 # JetPilot本体と外部リポジトリの状態を確認
...
- [EVS driver / 20ch前処理パイプライン技術レポート](docs/evs_pipeline_engineering_report.md)
- [EVS native benchmark実験プロトコル](tools/evs_benchmark/EXPERIMENT_PROTOCOL.md)
