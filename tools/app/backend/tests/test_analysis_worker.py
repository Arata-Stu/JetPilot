...
class SnapshotTrajectoryTests(unittest.TestCase):
    ...
    def test_event_tensor_preview_renders_polarity_bins_without_tensor_files(self) -> None:
        ...
        self.assertEqual(stats["packets_since_previous_preview"], 1)
        self.assertEqual(stats["empty_temporal_bin_count"], 0)
        self.assertEqual(stats["latest_empty_bin_run"], 0)
        self.assertEqual(stats["dark_cause"], "active")
